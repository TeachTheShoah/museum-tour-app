...
<div class="flex items-center mt-8 lg:mt-16 mb-16 px-8 md:px-16 lg:px-32 z-10">
  ...
  <div class="w-full lg:w-2/3">
    <div class="flex flex-col justify-between">
      ...
      <div class="mt-4 lg:mt-8 mr-2 lg:mr-12 font-bold md:text-2xl lg:text-4xl text-gray-600">
